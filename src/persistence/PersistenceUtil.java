...
//	public static List<BaseData> findAllBaseData(){
//		EntityManager em = emf.createEntityManager();
//		List<BaseData> baseDatas = (List<BaseData>) em.createNamedQuery("Subscriber.findAll").getResultList();
//		em.close();
//		
//		return baseDatas;
//		
...
//public static void findIMSIEvent(){
//	
//	EntityManager em = emf.createEntityManager();
//	List<BaseData> baseDatas = (List<BaseData>) em.createNamedQuery("BaseData.findIMSIEvent").getResultList();
//	 for(int i=0; i<baseDatas.size(); i++) {
//         System.out.println(baseDatas.toArray());
//     }
//	
//}
